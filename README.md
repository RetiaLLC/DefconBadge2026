...
- **[ESP32 Bus Pirate](firmware/buspirate/)** — a multi-protocol hardware-hacking multitool on the badge TFT (also USB-serial / Wi-Fi web CLI): I²C/SPI/UART/1-Wire/JTAG bus tools with **on-screen bus scan + live register monitor**, a **BME280 environment dashboard** that colours the ears by temperature, Wi-Fi/BLE scanners, and **on-board LoRa TX/RX verified badge-to-badge** (new SX127x driver). ⚠ Transmit- & attack-capable (Wi-Fi deauth, BLE spoof, RF jam) — **authorized use only**. Ready-to-flash: **[RetiaLLC/ESP32-Bus-Pirate @ badge-v1.0](https://github.com/RetiaLLC/ESP32-Bus-Pirate/releases/tag/badge-v1.0)**, ported from [KonradIT/geo-tp](https://github.com/KonradIT/ESP32-Bus-Pirate).
